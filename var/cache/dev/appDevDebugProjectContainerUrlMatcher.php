...
class appDevDebugProjectContainerUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        elseif (0 === strpos($pathinfo, '/platform')) {
            ...
            // editImageAction
            if (0 === strpos($pathinfo, '/platform/img/edit') && preg_match('#^/platform/img/edit/(?P<id>\\d+)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'editImageAction')), array (  '_controller' => 'OC\\PlatformBundle\\Controller\\AdvertController::editImageAction',));
            }
